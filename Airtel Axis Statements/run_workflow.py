#!/usr/bin/env python3
"""
Unified workflow script for Airtel Axis Card Cashback calculations.
...
def run_step(name, script_path, run_condition=True):
    ...
    try:
        # Run script and stream output to console
...
def main():
    print("=" * 70)
    print("      AIRTEL AXIS CASHBACK TRACKER — WORKFLOW RUNNER")
    print("=" * 70)
